...
# TC4: Selecting a district (e.g. "KLOJEN") re-centers the map and filters markers to that district only
...
# TC5: Selecting a district changes the marker count vs. "SELURUH KECAMATAN" (fewer markers shown)
...
# TC6: Switching back to "SELURUH KECAMATAN" restores the full marker set
